...
import {auth} from'../src/config/firebase'
  ...
  const Register = () =>{
    ...
    createUserWithEmailAndPassword(auth,email, username, password).then(()=>{
    ...
    return(
              <body class="body1">
                  <header>
                   ...
                   <div class="container">
          <div class="left">
           <img src={pic} alt="Pictures" width="550" height="550"/>
       ...
       <Link to="/" type="submit" class="signup" onClick={Register} >Sign up</Link>
